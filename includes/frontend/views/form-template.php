...
<div class="bytesis-donation-form-wrapper">
	<form id="bytesis-donation-form" class="bytesis-form" method="post" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>">
		...
		<div class="bytesis-form-group">
			<label class="bytesis-mono-label" for="bytesis_donor_name">Full Name *</label>
			<input type="text" id="bytesis_donor_name" name="donor_name" class="bytesis-input" required placeholder="John Doe" />
		</div>

		<div class="bytesis-form-group">
			<label class="bytesis-mono-label" for="bytesis_donor_email">Email Address *</label>
			<input type="email" id="bytesis_donor_email" name="donor_email" class="bytesis-input" required placeholder="john@example.com" />
		</div>

		<div class="bytesis-form-group">
			<label class="bytesis-mono-label" for="bytesis_donor_phone">Phone Number *</label>
			<input type="tel" id="bytesis_donor_phone" name="donor_phone" class="bytesis-input" required value="+880" />
		</div>

		<div class="bytesis-form-group">
			<label class="bytesis-mono-label" for="bytesis_fund_id">Choose Fund *</label>
		...
		<div class="bytesis-form-group">
			<label class="bytesis-mono-label">Choose Amount (৳) *</label>
			...
			<div class="bytesis-custom-amount-wrapper" style="display:none; margin-top:12px;">
				<input type="number" id="bytesis_custom_amount" class="bytesis-input" placeholder="Enter custom amount" min="10" />
			</div>
			<!-- Hidden field to hold the final amount -->
			<input type="hidden" id="bytesis_final_amount" name="amount" required />
		</div>

		<div class="bytesis-form-message" style="display:none;"></div>

		<div class="bytesis-form-submit">
			<button type="submit" id="bytesis_submit_btn" class="bytesis-btn-primary full-width">Donate Now</button>
		</div>
	</form>
</div>
